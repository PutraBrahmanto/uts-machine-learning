...
├── data_properti.csv                        # dataset
├── best_models_ridge.pkl                   # model terbaik
├── requirements.txt                        # requirements
├── Laporan                                 # Laporan dalam bentuk PDF
└── README.md                               # File ini
```
...
_Catatan: Nilai di atas adalah contoh. Silakan lihat output notebook untuk hasil aktual._
